...
```json
{
  "apiDescription" : "open api for tanzu java app",
  "apiOwner" : "demo",
  "apiSystem" : "customer-api",
  ...
  "projectName" : "java-rest-service-test",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->open api for tanzu j...(truncated), OWNER_VAL->demo, SYSTEM_VAL->customer-api]
